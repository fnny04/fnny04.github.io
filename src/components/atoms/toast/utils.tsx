import { RequiredToastProps, TToastPosition } from "./type";
...
export const wrapperClasses: Record<RequiredToastProps["type"], string> = {
  ...
  success: "bg-green-100 dark:bg-green-500 dark:text-green-100",
...
export const positionClasses: Record<TToastPosition, string> = {
